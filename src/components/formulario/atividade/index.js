...
export default function formCategoria(props){
  ...
  function onSubmit(values, actions, schema){
    ...
    var raw = JSON.stringify({"descricao": nomeAtividade,"iconAtividade":iconSelected});
      var requestOptions = {
        method: 'POST',
        headers: myHeaders,
        body: raw,
    ...
    fetch("https://mecpockpay.herokuapp.com/atividade", requestOptions)
...
<div className="card-body">
  <div className="row">
    ...
    <div className="form-group col-12 col-sm-12 col-md-4">
      ...
      <Field type="text" className="form-control" id="descricao" name="descricao"   />
  ...
  <Link to={props.linkAddVoltar} className="btn btn-flat btn-danger  active buttonMecPock zoom" role="button" aria-pressed="true">Voltar</Link>
