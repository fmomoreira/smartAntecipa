...
const FormPos = (props) =>{
  ...
  const [fabricantes, setFabricantes] = useState([])
          ...
          function onSubmit(values, actions, schema){
            ...
            var raw = JSON.stringify({"nome": nomeModelo, "fabricantePos": fabricantePos,"ativo": true});
            ...
            fetch("https://mecpockpay.herokuapp.com/modelopos", requestOptions)
              ...
              <div className="card-body">
                <div className="row">
                  <div className="form-group col-md-4">
                    ...
                    <Field type="text" className="form-control" id="nome" name="nome"/>
                ...
                <div  className="form-group col-md-4">
                  ...
                  <Field type="text" className="form-control" id="fabricantePos" name="fabricantePos" as="select">
                ...
                <Link to="/maquinaspos" className="btn btn-flat btn-danger  active buttonMecPock zoom" role="button" aria-pressed="true">Voltar</Link>
